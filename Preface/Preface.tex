...
Em particular, há vários exemplos que mostram um fragmento de código que pode ser executado.  Usamos o símbolo \ct{-->} para indicar o resultado que você obterá quando selecionar uma expressão e \menu{print it}:
...
\dothis{Vá em frente e leia o próximo capítulo!}
